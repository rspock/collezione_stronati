 ...
 * OldProfumo
 *
 * @ORM\Table(name="profumo")
 * @ORM\Entity(repositoryClass="Rs\ImportazioneBundle\Entity\OldProfumoRepository")
 */
class OldProfumo
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="scatola", type="string", length=10)
     */
    private $scatola;
